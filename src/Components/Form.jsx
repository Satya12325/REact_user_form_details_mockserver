            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    >
                        ...
                        <option key="D" value="director">Director</option>
                        <option key="AM" value="assitant">Assitant Manager</option>
                        <option key="DM" value="deputy">Deputy Manager</option>
                        <option key="CEO" value="ceo">CEO</option>
                        <option key="DV" value="developer">Developer</option>
                    </select>
                </div>
                <div>
                    <label>SALARY : </label>
